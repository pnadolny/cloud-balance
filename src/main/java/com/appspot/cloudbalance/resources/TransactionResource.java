...
public class TransactionResource {
    ...
    public String doGet(
        ...
        Map<String, String> payeeMap = new HashMap<>();
        Payee.getAllPayees().forEach(p -> payeeMap.put(p.getKey().getName(), (String) p.getProperty("type")));
